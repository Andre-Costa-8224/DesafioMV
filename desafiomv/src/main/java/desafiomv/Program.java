				...
				while (loopcli) {
					...
					//PROCURA DE CLIENTE ESPECÍFICO
						...
						if (tipoidentificacao==1) {
							...
							if (clientepfdao.findByCpf(cpf).size()>0) {
								System.out.print("-----------------------------------------------------------------------------------------------------------\n  | ");
					...
					//DELETAR CLIENTE
						...
						JasperPrint relatorio = JasperFillManager.fillReport("C:\\Users\\Rozanira\\Documents\\reports\\relatorio.jasper", null, conn.getConnection());
